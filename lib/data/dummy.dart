...
import 'package:eventsorg_mobile_organizer/model/image_obj.dart';
import 'package:eventsorg_mobile_organizer/model/inbox.dart';
import 'package:eventsorg_mobile_organizer/model/model_image.dart';
import 'package:eventsorg_mobile_organizer/model/music_album.dart';
import 'package:eventsorg_mobile_organizer/model/music_song.dart';
import 'package:eventsorg_mobile_organizer/model/events_model.dart';
import 'package:eventsorg_mobile_organizer/model/people.dart';
import 'package:eventsorg_mobile_organizer/model/photo_info.dart';
import 'package:eventsorg_mobile_organizer/model/review.dart';
import 'package:eventsorg_mobile_organizer/model/shop_category.dart';
import 'package:eventsorg_mobile_organizer/model/shop_product.dart';
import 'package:eventsorg_mobile_organizer/model/wizard.dart';
...
class Dummy {
  ...
  // static List<Events> getNewsData(int count) {
  //   List<Events> items = [];
  //   for (int i = 0; i < count; i++) {
  //     Events obj = new Events();
  //     obj.name = strings_medium[random.nextInt(strings_medium.length)];
  //     obj.location = news_category[random.nextInt(news_category.length)];
